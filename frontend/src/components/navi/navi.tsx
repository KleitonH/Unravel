// NAVI — mascote do Unravel como SVG paramétrico inline.
// Gato fofo estilo "storybook" (ref. Gemini): pelagem sombreada com tufos,
// orelhas com pelo interno, focinho rosa, óculos redondos de aro e olhos
// verdes expressivos. Cosméticos (hat/accessory/fur) e mood são overlays,
// pra loja prever ao vivo.
//
// PR 63d — redesign detalhado sobre a base do PR 63b. Continua 100% SVG
// paramétrico por camadas; os slots/coordenadas batem com o protótipo, então
// chapéus/acessórios encaixam sem reposicionar.
...
/** Paleta rica por pelagem — alimenta gradientes (highlight→base→sombra),
 *  barriga/peito, tufos, orelha interna, listra tabby (só laranja), olho e
 *  cor do bigode. */
type FurPalette = {
...
export function Navi({ size = 160, fur = "preto", hat = null, accessory = null, mood = "neutral", style }: NaviProps) {
  const f = FUR[(fur ?? "preto") as NaviFur] || FUR.preto
  const uid = useId().replace(/:/g, "")
  const gBody = `nb-${uid}`, gFace = `nf-${uid}`, gBelly = `ny-${uid}`, gEye = `ne-${uid}`, gShirt = `ns-${uid}`
  ...
  const Eyes = () => {
    if (mood === "happy") {
      return (
        <g stroke={ink} strokeWidth="4.2" strokeLinecap="round" fill="none">
          <path d="M73 80 q8 -10 16 0" />
          <path d="M111 80 q8 -10 16 0" />
        </g>
      )
    }
    if (mood === "sad") {
      return (
        <g>
          <ellipse cx="81" cy="83" rx="7.5" ry="9" fill={`url(#${gEye})`} />
          <ellipse cx="119" cy="83" rx="7.5" ry="9" fill={`url(#${gEye})`} />
          <circle cx="83" cy="81" r="2.6" fill={ink} />
          <circle cx="121" cy="81" r="2.6" fill={ink} />
    ...
    if (mood === "excited") {
      return (
        <g>
          <ellipse cx="81" cy="80" rx="10" ry="12" fill={`url(#${gEye})`} />
          <ellipse cx="119" cy="80" rx="10" ry="12" fill={`url(#${gEye})`} />
          <circle cx="80" cy="84" r="2" fill={ink} />
          <circle cx="118" cy="84" r="2" fill={ink} />
          <circle cx="84.5" cy="76" r="3.2" fill="#fff" />
          <circle cx="122.5" cy="76" r="3.2" fill="#fff" />
          <circle cx="78" cy="82" r="1.3" fill="#fff" opacity="0.8" />
          <circle cx="116" cy="82" r="1.3" fill="#fff" opacity="0.8" />
        </g>
      )
    }
    return (
      <g>
        <ellipse cx="81" cy="81" rx="8.4" ry="10.4" fill={`url(#${gEye})`} />
        <ellipse cx="119" cy="81" rx="8.4" ry="10.4" fill={`url(#${gEye})`} />
        <ellipse cx="81" cy="82" rx="3.1" ry="6.4" fill={ink} />
        <ellipse cx="119" cy="82" rx="3.1" ry="6.4" fill={ink} />
        <circle cx="83.6" cy="77.4" r="1.9" fill="#fff" />
        <circle cx="121.6" cy="77.4" r="1.9" fill="#fff" />
        <circle cx="79.5" cy="84.5" r="1" fill="#fff" opacity="0.7" />
        <circle cx="117.5" cy="84.5" r="1" fill="#fff" opacity="0.7" />
      </g>
    )
  }
  ...
  const Mouth = () => {
    ...
    return (
      <g stroke={ink} strokeWidth="2.6" fill="none" strokeLinecap="round">
        <path d="M100 95 v5" />
        <path d="M100 100 q-5.5 4.5 -10 1" />
        <path d="M100 100 q5.5 4.5 10 1" />
      </g>
    )
  }
    ...
    <svg width={size} height={size} viewBox="0 0 200 210" style={style} fill="none">
      <defs>
        <linearGradient id={gBody} x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="48%" stopColor={f.base} />
          <stop offset="100%" stopColor={f.lo} />
        </linearGradient>
        <radialGradient id={gFace} cx="50%" cy="38%" r="68%">
          <stop offset="0%" stopColor={f.hi} />
          <stop offset="60%" stopColor={f.base} />
          <stop offset="100%" stopColor={f.lo} />
        </radialGradient>
        <radialGradient id={gBelly} cx="50%" cy="40%" r="65%">
          <stop offset="0%" stopColor={f.belly} />
          <stop offset="100%" stopColor={f.tuft} />
        </radialGradient>
        <radialGradient id={gEye} cx="42%" cy="35%" r="75%">
          <stop offset="0%" stopColor={f.eyeHi} />
          <stop offset="55%" stopColor={f.eye} />
          <stop offset="100%" stopColor="#1f9e58" />
        </radialGradient>
      ...
      <g>
        ...
        {f.stripe && (
          <g stroke={f.stripe} strokeWidth="4" strokeLinecap="round" opacity="0.8" fill="none">
            <path d="M156 150 q12 0 18 -8" />
            <path d="M159 134 q12 0 18 -8" />
            <path d="M164 118 q10 -1 15 -8" />
          </g>
        )}
      </g>
      ...
      <g>
        ...
        <g stroke={f.lo} strokeWidth="1.4" opacity="0.6" strokeLinecap="round">
          <path d="M76 200 v4" /><path d="M84 200 v4" />
          <path d="M116 200 v4" /><path d="M124 200 v4" />
        </g>
      </g>
      ...
      {/* peito felpudo */}
      <path d="M72 132 q5 9 11 5 q4 9 17 7 q13 2 17 -7 q6 4 11 -5 q-3 24 -28 24 q-25 0 -28 -24 Z"
        fill={`url(#${gBelly})`} opacity="0.92" />

      {/* camiseta roxa com pata */}
      ...
      {accessory === "jaleco" && (
        <g>
          ...
          <circle cx="100" cy="150" r="2.2" fill="#a59fc8" />
          <circle cx="100" cy="167" r="2.2" fill="#a59fc8" />
        </g>
      )}
      ...
      {accessory !== "jaleco" && (
        <g fill="#fff" opacity="0.96">
          ...
          <circle cx="91" cy="147" r="3.1" />
          <circle cx="100" cy="144" r="3.1" />
          <circle cx="109" cy="147" r="3.1" />
        </g>
      )}
      ...
      {accessory === "gravata" && (
        <g>
          <path d="M100 120 l-17 -9 v18 Z" fill="#ed54f2" />
          <path d="M100 120 l17 -9 v18 Z" fill="#ed54f2" />
          <path d="M100 120 l-17 -9 v9 Z" fill="#f98bfa" opacity="0.6" />
          <path d="M100 120 l17 -9 v9 Z" fill="#f98bfa" opacity="0.6" />
      ...
      <g>
        ...
        <path d="M62 51 L58 28 L85 45 Z" fill={f.earIn} />
        <path d="M138 51 L142 28 L115 45 Z" fill={f.earIn} />
        <path d="M62 51 L58 28 L72 38 Z" fill="#fff" opacity="0.25" />
        <path d="M138 51 L142 28 L128 38 Z" fill="#fff" opacity="0.25" />
        {/* tufos na base da orelha */}
        <path d="M55 56 q-7 -2 -9 -8 q6 1 9 4 Z" fill={f.tuft} opacity="0.8" />
        <path d="M145 56 q7 -2 9 -8 q-6 1 -9 4 Z" fill={f.tuft} opacity="0.8" />
      </g>
      ...
      {/* listras tabby (laranja) */}
      {f.stripe && (
        <g stroke={f.stripe} strokeWidth="3.4" strokeLinecap="round" fill="none" opacity="0.85">
          <path d="M100 40 v13" />
          <path d="M89 44 q3 7 -1 13" />
          <path d="M111 44 q-3 7 1 13" />
          <path d="M62 64 q8 2 13 -2" />
          <path d="M138 64 q-8 2 -13 -2" />
        </g>
      )}
      ...
      <g stroke={f.whisker} strokeWidth="1.6" strokeLinecap="round" opacity="0.75" fill="none">
        <path d="M60 86 q-13 -3 -24 -1" />
        <path d="M60 92 q-13 1 -23 5" />
        <path d="M140 86 q13 -3 24 -1" />
        <path d="M140 92 q13 1 23 5" />
      </g>

      <Eyes />

      {/* óculos redondos de aro */}
      <g>
      ...
      {hat === "headset" && (
        <g>
          ...
          <rect x="43" y="60" width="19" height="33" rx="8" fill="#2fc77e" />
          <rect x="138" y="60" width="19" height="33" rx="8" fill="#2fc77e" />
          ...
          <circle cx="32" cy="116" r="5.5" fill="#ed54f2" />
          <circle cx="30" cy="114" r="2" fill="#fff" opacity="0.7" />
        </g>
      )}
      {hat === "antenas" && (
        <g>
          ...
          <circle cx="61" cy="4" r="7.5" fill="#a78bfa" />
          <circle cx="139" cy="4" r="7.5" fill="#a78bfa" />
          <circle cx="59" cy="2" r="2.6" fill="#fff" opacity="0.8" />
          <circle cx="137" cy="2" r="2.6" fill="#fff" opacity="0.8" />
        </g>
      )}
      {hat === "coroa" && (
        <g>
